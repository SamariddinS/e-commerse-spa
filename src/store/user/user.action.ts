import { USER_ACTION_TYPES, UserWithEmailAndPass} from './user.types';
...
export type EmailSignInStart = ActionWithPayload<USER_ACTION_TYPES.EMAIL_SIGN_IN_START, UserWithEmailAndPass>
